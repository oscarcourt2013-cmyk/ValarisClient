...
public interface MinecraftAdapter {
    ...
    default void openValarisSettings() {
        openClickGui();
    }

    /** Opens the vanilla Minecraft title screen (without Valaris redirect). */
    ...
    /** Closes the account switcher and returns to the Valaris title menu. */
    ...
    /** Resolves a ValarisClient translation key using the active Minecraft language. */
