...
public final class DiscordPresenceSnapshot {
    ...
    public DiscordPresenceSnapshot(String details, String state,
        ...
        this.largeImageKey = largeImageKey != null && !largeImageKey.isBlank() ? largeImageKey : "valaris_logo";
        this.largeImageText = largeImageText != null ? largeImageText : "ValarisClient";
