...
public final class ColorPickerWidget {
    ...
    public void render(RenderContext ctx, Theme theme, int x, int y) {
        ...
        int svX = x;
        int svY = y;
        int hueX = x + svSize + ValarisDesign.SPACE_SM;
        int hueY = y;
        int hueW = 10;
        int hueH = svSize;
        int alphaY = y + svSize + ValarisDesign.SPACE_SM;
        int previewX = hueX;
        int previewY = alphaY;
        ...
        // Alpha bar
        int alphaW = svSize + hueW + ValarisDesign.SPACE_SM;
    ...
    public boolean mousePressed(double mx, double my, int x, int y, int button) {
        ...
        int alphaY = y + svSize + ValarisDesign.SPACE_SM;
        int alphaW = svSize + 10 + ValarisDesign.SPACE_SM;
