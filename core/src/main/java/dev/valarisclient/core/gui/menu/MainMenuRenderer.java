...
import dev.valarisclient.core.gui.clickgui.ClickGuiView;
...
/**
 * ClickGUI hub — compact stacked buttons over panorama/blur.
 */
public final class MainMenuRenderer {
    ...
    private static final String[] LABEL_KEYS = {
            "valaris.gui.main_menu.resume",
            "valaris.gui.main_menu.modules",
            "valaris.gui.main_menu.hud_editor",
            "valaris.gui.main_menu.configurations",
            "valaris.gui.main_menu.cosmetics",
            "valaris.gui.main_menu.settings"
    };
    ...
    public void renderPanel(RenderContext ctx, Theme theme, int x, int y,
        ...
        ValarisLogo.draw(ctx, layout.logoX(), layout.logoY() + slideY, layout.logoH(), 0xFFFFFFFF);

        String versionLabel = ValarisLang.get("valaris.gui.main_menu.version", "Valaris %s", version);
        ...
        String hint = ValarisLang.get("valaris.gui.main_menu.hint", "Right Shift  ·  H = HUD");
