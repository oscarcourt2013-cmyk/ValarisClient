...
/**
 * Records in-game video clips to {@code config/valarisclient/clips/*.mp4}.
 * ValarisClient Launcher scans the same folder on the Media page.
 */
public final class ClipToolsModule extends Module {

    /** GLFW_KEY_F8 — rebindable via Valaris keybind config. */
    ...
    public ClipToolsModule(HudManager hud, ThemeManager themes, MinecraftAdapter adapter,
        ...
        super("clip-recorder", "Clip Recorder", "Export MP4 clips to config/valarisclient/clips", ModuleCategory.CREATOR);
