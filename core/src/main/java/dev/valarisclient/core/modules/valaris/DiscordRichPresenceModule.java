...
/**
 * Discord Rich Presence — clean server context, compact stats, Valaris branding.
 *
...
public final class DiscordRichPresenceModule extends Module {
    ...
    private final BooleanSetting showAccountTier =
            addSetting(new BooleanSetting("tier", "Show Valaris tier", "Include account tier on secondary line", false));
    ...
    public DiscordRichPresenceModule(DiscordRpcService discord, MinecraftAdapter adapter,
                                     ModuleManager modules, ValarisAccountService account) {
