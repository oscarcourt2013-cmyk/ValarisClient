 ...
 *
 * <p>Shared IDs with the launcher: {@code valaris-crimson}, {@code valaris-midnight},
 * {@code valaris-aurora}, {@code valaris-obsidian}, {@code valaris-ember}.</p>
 */
public final class ThemeManager implements ConfigBinding {

    /** Brand red — signature Valaris look (default). */
    public static final Theme VALARIS_CRIMSON = new Theme(
            "valaris-crimson", "Valaris Crimson",
            0xFFE11D2E, // accent
    ...
    public static final Theme VALARIS_MIDNIGHT = new Theme(
            "valaris-midnight", "Valaris Midnight",
            0xFF38BDF8, // accent
    ...
    public static final Theme VALARIS_AURORA = new Theme(
            "valaris-aurora", "Valaris Aurora",
            0xFF34D399, // accent
    ...
    public static final Theme VALARIS_OBSIDIAN = new Theme(
            "valaris-obsidian", "Valaris Obsidian",
            0xFFF0D78C, // accent
    ...
    public static final Theme VALARIS_EMBER = new Theme(
            "valaris-ember", "Valaris Ember",
            0xFFFDBA74, // accent
    ...
    public ThemeManager() {
        register(VALARIS_CRIMSON);
        register(VALARIS_MIDNIGHT);
        register(VALARIS_AURORA);
        register(VALARIS_OBSIDIAN);
        register(VALARIS_EMBER);
        this.active = VALARIS_CRIMSON;
    }
    ...
    /**
     * Maps legacy IDs ({@code valaris-dark}, {@code valaris-light}) to the current set.
     */
    public static String normalizeId(String id) {
        if (id == null || id.isBlank()) {
            return VALARIS_CRIMSON.id();
        }
        return switch (id) {
            case "valaris-dark" -> VALARIS_CRIMSON.id();
            case "valaris-light" -> VALARIS_MIDNIGHT.id();
            default -> id;
        };
    }
