...
/**
 * ValerisClient v1.1 design tokens — spacing, radii, motion, typography scale.
 * Colors live on {@link dev.valerisclient.core.theme.Theme}; this class holds layout and motion.
 */
public final class ValerisDesign {

    /** Synced from {@code gradle.properties} {@code mod_version} at build time. */
    public static final String VERSION = ValerisVersion.VERSION;
