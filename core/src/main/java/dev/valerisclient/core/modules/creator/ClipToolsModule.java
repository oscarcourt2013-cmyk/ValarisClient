...
/**
 * Records in-game video clips to {@code config/valerisclient/clips/*.mp4}.
 * ValerisClient Launcher scans the same folder on the Media page.
 */
public final class ClipToolsModule extends Module {
    ...
    public ClipToolsModule(HudManager hud, ThemeManager themes, MinecraftAdapter adapter,
        ...
        super("clip-recorder", "Clip Recorder", "Export MP4 clips to config/valerisclient/clips", ModuleCategory.CREATOR);
