...
public final class ValerisAccountModule extends Module {
    ...
    public ValerisAccountModule(HudManager hud, ThemeManager themes, MinecraftAdapter adapter,
    ...
    private static final class Element extends HudElement {
        ...
        Element(ThemeManager themes, MinecraftAdapter adapter, ValerisAccountService account,
