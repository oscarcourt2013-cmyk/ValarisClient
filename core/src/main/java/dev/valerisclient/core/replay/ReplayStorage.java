...
public final class ReplayStorage {
    ...
    public void save(ReplaySession session, String name) {
        try {
            ...
            ValerisClient.LOGGER.info("Saved replay to {}", file);
        } catch (IOException e) {
            ValerisClient.LOGGER.error("Failed to save replay {}", name, e);
        }
    }
    ...
    public boolean load(ReplaySession session, String name) {
        ...
        try {
            ...
            ValerisClient.LOGGER.error("Failed to load replay {}", name, e);
            return false;
        }
    }
