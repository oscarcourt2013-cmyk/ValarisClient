...
public final class ValerisXpHandler {

    private final ValerisAccountManager account;
    private final NotificationManager notifications;

    public ValerisXpHandler(ValerisAccountManager account, NotificationManager notifications) {
    ...
    public void handle(JsonObject payload) {
        ...
        notifications.success("Valeris XP", "⚡ +" + amount + " XP Valeris (" + label + ")");
    }
}
