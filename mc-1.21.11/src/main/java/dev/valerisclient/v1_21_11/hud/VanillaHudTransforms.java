...
import dev.valerisclient.core.hud.vanilla.VanillaHudProxyElement;
import dev.valerisclient.core.hud.vanilla.VanillaHudTransformHelper;
import net.minecraft.client.Minecraft;
import net.minecraft.client.gui.GuiGraphics;

/** Applies HUD-editor layout transforms before vanilla {@link net.minecraft.client.gui.Gui} layers draw. */
public final class VanillaHudTransforms {
    ...
    public static void push(GuiGraphics graphics, VanillaHudComponent component) {
        ...
        // Default layout + identity transform: skip matrix work entirely.
    ...
    public static void pop(GuiGraphics graphics, VanillaHudComponent component) {
