...
public final class ValerisTabBadgeRenderer {
    ...
    public static void draw(GuiGraphics graphics, int x, int y) {
        int h = height();
        int w = width();
        int bg = ValerisHooks.clientBadgeBackground();
        int accent = ValerisHooks.clientBadgeAccent();
        int fg = ValerisHooks.clientBadgeForeground();
