...
import dev.stellarclient.core.gui.social.SocialHubUi;
...
/** In-game social hub shell for 26.2. */
public final class SocialHubScreen extends Screen {

    private final GuiRenderContext renderContext = new GuiRenderContext();
    private final SocialHubUi ui = new SocialHubUi(StellarClient.get().social(), StellarClient.get().adapter());
