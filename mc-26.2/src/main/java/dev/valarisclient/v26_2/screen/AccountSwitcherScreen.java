...
import dev.valarisclient.core.gui.account.AccountSwitcherUi;
...
public final class AccountSwitcherScreen extends Screen {
    ...
    private final AccountSwitcherUi ui = new AccountSwitcherUi(ValarisClient.get().adapter());
    ...
    public void extractRenderState(GuiGraphicsExtractor extractor, int mouseX, int mouseY, float delta) {
        ...
        ui.render(renderContext, ValarisClient.get().themes().active(), mouseX, mouseY);
    }
    ...
    @Override
    public void onClose() {
        Minecraft.getInstance().gui.setScreen(parent != null ? parent : new ValarisTitleScreen());
    }
}
