...
public final class DatabaseFactory {
    ...
    public static Database create(StellarClientPlugin plugin) {
        FileConfiguration cfg = plugin.getConfig();
        String type = cfg.getString("database.type", "sqlite");
        HikariConfig hikari = new HikariConfig();
        hikari.setPoolName("StellarClient");
        ...
        if ("mysql".equalsIgnoreCase(type)) {
            ...
            String db = cfg.getString("database.mysql.database", "StellarClient");
            ...
            File file = new File(plugin.getDataFolder(), cfg.getString("database.sqlite-file", "StellarClient.db"));
